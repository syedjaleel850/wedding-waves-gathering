      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          <div className="floral-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="group relative overflow-hidden rounded-full bg-lavender-600 px-6 py-2 font-medium text-white shadow-md transition-all duration-300 hover:bg-lavender-700 hover:shadow-lg disabled:opacity-70"
              >
          ...
          <motion.div
            ...
            initial="hidden"
            animate={controls}
            className="floral-card max-h-[480px] overflow-y-auto"
          >
            <h3 className="mb-4 text-xl font-serif font-medium text-gray-900">
              Recent Messages
            </h3>
