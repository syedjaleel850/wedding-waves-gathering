  ...
  return <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 py-20 text-center">
        ...
        delay: 1
          ...
          <a href="/rsvp" className="group relative overflow-hidden rounded-full bg-lavender-600 px-8 py-3 font-medium text-white shadow-md transition-all duration-300 hover:bg-lavender-700 hover:shadow-lg">
          ...
          <a href="/details" className="gold-border rounded-full bg-white/80 px-8 py-3 font-medium text-lavender-700 shadow-sm backdrop-blur-sm transition-all duration-300 hover:bg-white hover:shadow-md">
            Event Details
          </a>
        </motion.div>
      </div>
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center">
        ...
        repeatType: "reverse"
          ...
          <a href="#event-details" aria-label="Scroll down" className="flex h-12 w-12 items-center justify-center rounded-full bg-white/80 text-lavender-500 shadow-sm backdrop-blur-sm transition-all duration-300 hover:bg-white hover:text-lavender-600 hover:shadow-md">
