  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between px-4">
        <NavLink 
          to="/" 
          className="text-2xl font-cursive font-medium text-lavender-700"
        >
          R & A
        </NavLink>
        ...
        {/* Mobile menu button */}
        <button
          className="flex h-10 w-10 items-center justify-center rounded-full bg-white/80 text-lavender-700 backdrop-blur-sm md:hidden"
